...
//                o.put("documentContent.firstColumnDetails.values",)
//JsonNode a=new JsonNode("a");
//                o.replace("documentSettings.logo",  nodelogo.get("logo"));
                ObjectNode documentSettings=(ObjectNode) o.get("documentSettings");
...
//                a.replace("logo",nodelogo.get("logo"));
